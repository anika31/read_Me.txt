...
public class LoanAssistant extends JFrame {
	...
	private void computeButtonActionPerformed(ActionEvent e) {
		...
		"Do you want to use the minimmPayment?","Input Error",JOptionPane.YES_NO_OPTION,
		...
		//reset payment prior to analysis to fix at two decimal places
		payment=Double.valueOf(paymentTextField.getText()).doubleValue();
		//show analysis
	...
	public boolean validateDecimalNumber(JTextField tf) {
		//check to see if text field contains
